...
video script — is generated by Granite on watsonx.ai. The vision stage uses a
supporting multimodal model because watsonx doesn't yet offer a Granite vision
model, following the same hybrid pattern used by previous challenge winners.
...
| 👁️ Visual Analysis | Llama 3.2 11B Vision | Reads video frames, decodes editing grammar | IBM watsonx.ai |
